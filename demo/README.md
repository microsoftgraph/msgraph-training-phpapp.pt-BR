...
- [Php](http://php.net/downloads.php) instalado em sua máquina de desenvolvimento. Se você não tiver o PHP, visite o link anterior para opções de download. (**Observação:** este tutorial foi escrito com o PHP versão 7.4.4. As etapas deste guia podem funcionar com outras versões, mas que não foram testadas.
