# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="da3e3-101">Como executar o projeto concluído</span><span class="sxs-lookup"><span data-stu-id="da3e3-101">How to run the completed project</span></span>
